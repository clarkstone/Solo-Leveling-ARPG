...
#include "P05_TRNS_META_PHASE6.generated.h"
...
class SIMPLEAPP_API UP05_TRNS_PHASE6 : public UActorComponent
{
    GENERATED_BODY()
...
public:
    ...
    UPROPERTY(EditAnywhere, Blueprint6ReadWrite, Category = "Meta Phase6")
