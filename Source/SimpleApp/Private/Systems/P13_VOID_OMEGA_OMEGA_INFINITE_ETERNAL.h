...
#include "P13_VOID_OMEGA_OMEGA_INFINITE_ETERNAL.generated.h"
...
class SIMPLEAPP_API UP13_VOID_OMEGA_OMEGA_INFINITE_ETERNAL : public UActorComponent
{
    GENERATED_BODY()

public:
    UP13_VOID_OMEGA_OMEGA_INFINITE_ETERNAL();
    ...
    UPROPERTY(BlueprintAssignable, Category = "Omega Omega Infinite Eternal Void")
    FOnOmegaOmegaInfiniteEternalVoidDeactivated OnOmegaOmegaInfiniteEternalVoidDeactivated;
