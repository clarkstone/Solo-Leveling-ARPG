...
#include "P17_TRNS_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL.generated.h"
...
class SIMPLEAPP_API UP17_TRNS_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL : public UActorComponent
{
    GENERATED_BODY()

public:
    UP17_TRNS_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL();
