#include "P09_OMEGA_STATE_SYSTEM.h"
#include "GameFramework/Character.h"
#include "Kismet/GameplayStatics.h"

// Sets default values for this component's properties
UP09_OMEGA_STATE_SYSTEM::UP09_OMEGA_STATE_SYSTEM()
{
    PrimaryComponentTick.bCanEverTick = false;
    OmegaStateLevel = 0;
    MaxOmegaStateLevel = 100;
    bIsOmegaStateActive = false;
    OmegaStatePowerCost = 50.0f;
    OmegaStateThreshold = 50.0f;
...
void UP09_OMEGA_STATE_SYSTEM::BeginPlay()
{
    Super::BeginPlay();
    UpdateOmegaStateStats();
}

void UP09_OMEGA_STATE_SYSTEM::ActivateOmegaState()
{
...
void UP09_OMEGA_STATE_SYSTEM::DeactivateOmegaState()
{
...
void UP09_OMEGA_STATE_SYSTEM::SetOmegaStateLevel(int32 NewLevel)
{
...
void UP09_OMEGA_STATE_SYSTEM::UseOmegaStatePower()
{
...
void UP09_OMEGA_STATE_SYSTEM::PerformOmegaStateAbility()
{
...
bool UP09_OMEGA_STATE_SYSTEM::IsOmegaStateActive() const
{
    return bIsOmegaStateActive;
}

int32 UP09_OMEGA_STATE_SYSTEM::GetOmegaStateLevel() const
{
    return OmegaStateLevel;
}

float UP09_OMEGA_STATE_SYSTEM::GetOmegaStatePowerCost() const
{
    return OmegaStatePowerCost;
}

void UP09_OMEGA_STATE_SYSTEM::ExerciseOmegaPhaseUltimacy()
{
    if (bIsOmegaStateActive)
    {
...
void UP09_OMEGA_STATE_SYSTEM::AchieveOmegaPhaseFinalUltimacy()
{
    if (bIsOmegaStateActive)
    {
        float UltimacyPower = OmegaPhaseUltimacy * (OmegaStateLevel / 100.0f);
...
void UP09_OMEGA_STATE_SYSTEM::ControlFinalStateTransitions()
{
    if (bIsOmegaStateActive)
    {
...
void UP09_OMEGA_STATE_SYSTEM::AccessUltimateConsciousness()
{
    if (bIsOmegaStateActive)
    {
...
void UP09_OMEGA_STATE_SYSTEM::WieldFinalUltimacy()
{
    if (bIsOmegaStateActive)
    {
...
bool UP09_OMEGA_STATE_SYSTEM::CanActivateOmegaState() const
{
    return OmegaStateLevel > 0;
}

void UP09_OMEGA_STATE_SYSTEM::UpdateOmegaStateStats()
{
    ...
    StateTransitions = OmegaStateLevel * 4.8f;
    UltimateConsciousness = OmegaStateLevel * 4.9f;
    FinalUltimacy = OmegaStateLevel * 5.1f;
}

void UP09_OMEGA_STATE_SYSTEM::OnOmegaStateChanged()
{
