#include "P05_OMEGA_STATE_SYSTEM_V2.h"
#include "GameFramework/Character.h"
#include "Kismet/GameplayStatics.h"

// Sets default values for this component's properties
UP05_OMEGA_STATE_SYSTEM_V2::UP05_OMEGA_STATE_SYSTEM_V2()
{
...
void UP05_OMEGA_STATE_SYSTEM_V2::BeginPlay()
{
    Super::BeginPlay();
    UpdateOmegaStateStats();
}

void UP05_OMEGA_STATE_SYSTEM_V2::ActivateOmegaState()
{
    if (!bIsOmegaStateActive && CanActivateOmegaState())
    {
        ...
        OnOmegaStateChanged();
        UE_LOG(LogTemp, Warning, TEXT("Omega State System V2 Activated at Level: %d"), OmegaStateLevel);
    }
}

void UP05_OMEGA_STATE_SYSTEM_V2::DeactivateOmegaState()
{
    if (bIsOmegaStateActive)
    {
        ...
        OnOmegaStateChanged();
        UE_LOG(LogTemp, Warning, TEXT("Omega State System V2 Deactivated."));
    }
}

void UP05_OMEGA_STATE_SYSTEM_V2::SetOmegaStateLevel(int32 NewLevel)
{
...
void UP05_OMEGA_STATE_SYSTEM_V2::UseOmegaStatePower()
{
...
void UP05_OMEGA_STATE_SYSTEM_V2::PerformOmegaStateAbility()
{
...
bool UP05_OMEGA_STATE_SYSTEM_V2::IsOmegaStateActive() const
{
    return bIsOmegaStateActive;
}

int32 UP05_OMEGA_STATE_SYSTEM_V2::GetOmegaStateLevel() const
{
    return OmegaStateLevel;
}

float UP05_OMEGA_STATE_SYSTEM_V2::GetOmegaStatePowerCost() const
{
    return OmegaStatePowerCost;
}

void UP05_OMEGA_STATE_SYSTEM_V2::ExerciseOmegaPhaseUltimacy()
{
    if (bIsOmegaStateActive)
    {
...
void UP05_OMEGA_STATE_SYSTEM_V2::AchieveOmegaPhaseFinalUltimacy()
{
    if (bIsOmegaStateActive)
    {
...
void UP05_OMEGA_STATE_SYSTEM_V2::ControlFinalStateTransitions()
{
    if (bIsOmegaStateActive)
    {
...
void UP05_OMEGA_STATE_SYSTEM_V2::AccessUltimateConsciousness()
{
    if (bIsOmegaStateActive)
    {
...
void UP05_OMEGA_STATE_SYSTEM_V2::WieldFinalUltimacy()
{
    if (bIsOmegaStateActive)
    {
...
bool UP05_OMEGA_STATE_SYSTEM_V2::CanActivateOmegaState() const
{
    return OmegaStateLevel > 0;
}

void UP05_OMEGA_STATE_SYSTEM_V2::UpdateOmegaStateStats()
{
    ...
    StateTransitions = OmegaStateLevel * 4.4f;
    UltimateConsciousness = OmegaStateLevel * 4.6f;
    FinalUltimacy = OmegaStateLevel * 5.0f;
}

void UP05_OMEGA_STATE_SYSTEM_V2::OnOmegaStateChanged()
{
