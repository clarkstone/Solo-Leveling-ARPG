...
#include "P19_VOID_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL.generated.h"
...
class SIMPLEAPP_API UP19_VOID_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL : public UActorComponent
{
    GENERATED_BODY()

public:
    UP19_VOID_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL();
