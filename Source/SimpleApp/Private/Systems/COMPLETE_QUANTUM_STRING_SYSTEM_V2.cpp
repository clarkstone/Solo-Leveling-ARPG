#include "COMPLETE_QUANTUM_STRING_SYSTEM_V2.h"
...
void UCOMPLETE_QUANTUM_STRING_SYSTEM::UpdateQuantumStringStats()
{
    ...
    QuantumStringLifeEssence = QuantumStringLevel * 23.5f;
    StringQuantumRenewal = QuantumStringLevel * 23.3f;
    QuantumStringEternalContinuum = QuantumStringLevel * 23.4f;
    TimelessQuantumStringPerpetuation = QuantumStringLevel * 23.2f;
    AbsoluteQuantumStringSufficiency = QuantumStringLevel * 24.0f;
}
