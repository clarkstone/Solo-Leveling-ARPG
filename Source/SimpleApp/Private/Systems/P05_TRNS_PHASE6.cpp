#include "P05_TRNS_PHASE6.h"
#include "GameFramework/Character.h"
#include "Kismet/GameplayStatics.h"

// Sets default values for this component's properties
UP05_TRNS_PHASE6::UP05_TRNS_PHASE6()
{
    PrimaryComponentTick.bCanEverTick = false;
    MetaPhase6Level = 0;
    MaxMetaPhase6Level = 100;
    bIsMetaPhase6Active = false;
    MetaPhase6PowerCost = 30.0f;
    MetaPhase6Threshold = 30.0f;
...
void UP05_TRNS_PHASE6::BeginPlay()
{
    Super::BeginPlay();
    UpdateMetaPhase6Stats();
}

void UP05_TRNS_PHASE6::ActivateMetaPhase6()
{
...
void UP05_TRNS_PHASE6::DeactivateMetaPhase6()
{
...
void UP05_TRNS_PHASE6::SetMetaPhase6Level(int32 NewLevel)
{
...
void UP05_TRNS_PHASE6::UseMetaPhase6Power()
{
...
void UP05_TRNS_PHASE6::PerformMetaPhase6Ability()
{
...
bool UP05_TRNS_PHASE6::IsMetaPhase6Active() const
{
    return bIsMetaPhase6Active;
}

int32 UP05_TRNS_PHASE6::GetMetaPhase6Level() const
{
    return MetaPhase6Level;
}

float UP05_TRNS_PHASE6::GetMetaPhase6PowerCost() const
{
    return MetaPhase6PowerCost;
}

void UP05_TRNS_PHASE6::ExerciseMetaPhase6Dominion()
{
    if (bIsMetaPhase6Active)
    {
...
void UP05_TRNS_PHASE6::TranscendPhase6UltimateRecursion()
{
    if (bIsMetaPhase6Active)
    {
...
void UP05_TRNS_PHASE6::AccessMetaPhase6InfiniteConsciousness()
{
    if (bIsMetaPhase6Active)
    {
...
void UP05_TRNS_PHASE6::EvolveConceptuallyPhase6()
{
    if (bIsMetaPhase6Active)
    {
...
void UP05_TRNS_PHASE6::WieldPhase6UltimateAuthority()
{
    if (bIsMetaPhase6Active)
    {
...
bool UP05_TRNS_PHASE6::CanActivateMetaPhase6() const
{
    return MetaPhase6Level > 0;
}

void UP05_TRNS_PHASE6::UpdateMetaPhase6Stats()
{
    // Update meta phase6 properties based on level
    MetaPhase6Dominion = MetaPhase6Level * 4.0f;
    Phase6UltimateRecursion = MetaPhase6Level * 3.8f;
    MetaPhase6InfiniteConsciousness = MetaPhase6Level * 3.6f;
    ConceptualPhase6Evolution = MetaPhase6Level * 3.7f;
    Phase6UltimateAuthority = MetaPhase6Level * 4.2f;
}

void UP05_TRNS_PHASE6::OnMetaPhase6StateChanged()
{
