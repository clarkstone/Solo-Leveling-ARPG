...
#include "P28_EXST_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL.generated.h"
...
class SIMPLEAPP_API UP28_EXST_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL : public UActorComponent
{
    GENERATED_BODY()

public:
    UP28_EXST_OMEGA_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL();
    ...
    void ActivateOmegaOmegaOmegaInfiniteEternalExistence();

    UFUNCTION(BlueprintCallable, Category = "Omega Omega Infinite Eternal Existence")
    void DeactivateOmegaOmegaOmegaInfiniteEternalExistence();
