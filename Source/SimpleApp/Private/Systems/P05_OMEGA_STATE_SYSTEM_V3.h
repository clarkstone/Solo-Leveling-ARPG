...
#include "P05_OMEGA_STATE_SYSTEM_V3.generated.h"
...
class SIMPLEAPP_API UP05_OMEGA_STATE_SYSTEM : public UActorComponent
{
    GENERATED_BODY()

public:
    UP05_OMEGA_STATE_SYSTEM_V3();
    ...
    UPROPERTY(BlueprintAssignable, Category = "Omega State")
    FOnOmegaStateLevelChanged OnOmegaStateLevelChanged);
