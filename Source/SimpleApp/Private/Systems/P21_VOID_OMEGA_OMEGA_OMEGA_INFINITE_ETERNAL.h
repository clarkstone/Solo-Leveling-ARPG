...
#include "P21_VOID_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL.generated.h"
...
class SIMPLEAPP_API UP21_VOID_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL : public UActorComponent
{
    GENERATED_BODY()

public:
    UP21_VOID_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL();
