...
#include "P25_TRNS_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL.generated.h"
...
class SIMPLEAPP_API UP25_TRNS_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL : public UActorComponent
{
    GENERATED_BODY()

public:
    UP25_TRNS_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL();
