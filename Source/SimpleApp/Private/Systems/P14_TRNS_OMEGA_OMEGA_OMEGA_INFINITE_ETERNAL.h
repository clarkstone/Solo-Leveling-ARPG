...
#include "P14_TRNS_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnOmegaOmegaOmegaInfiniteEternalTranscendenceActivated, int32, NewLevel);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnOmegaOmegaOmegaInfiniteEternalTranscendenceDeactivated, int32, CurrentLevel);
...
class SIMPLEAPP_API UP14_TRNS_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL : public UActorComponent
{
    GENERATED_BODY()

public:
    UP14_TRNS_OMEGA_OMEGA_OMEGA_INFINITE_ETERNAL();

    // Omega Omega Omega Infinite Eternal Transcendence Properties
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Omega Omega Omega Infinite Eternal Transcendence")
    ...
    // Omega Omega Omega Infinite Eternal Transcendence Events
    UPROPERTY(BlueprintAssignable, Category = "Omega Omega Omega Infinite Eternal Transcendence")
    ...
    // Omega Omega Omega Infinite Eternal Transcendence Functions
    ...
    // Omega Omega Omega Infinite Eternal Transcendence Abilities
    UFUNCTION(BlueprintCallable, Category = "Omega Omega Infinite Eternal Transcendence")
