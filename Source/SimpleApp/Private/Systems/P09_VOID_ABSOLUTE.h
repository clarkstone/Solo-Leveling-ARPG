...
#include "P09_VOID_ABSOLUTE.generated.h"
...
class SIMPLEAPP_API UP09_VOID_ABSOLUTE : public UActorComponent
{
    GENERATED_BODY()
...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Absolute Void")
    float AbsoluteUltimateAnnihilation;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Absolute Void")
    float AbsolutePerfectVoidEmptiness;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Absolute Void")
    float AbsoluteConceptualUltimateOblivion;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Absolute Void")
    float AbsoluteExistenceUltimateNegation;
    ...
    UFUNCTION(BlueprintCallable, Category = "Absolute Void")
    void AchieveAbsolutePerfectVoidEmptiness();

    UFUNCTION(BlueprintCallable, Category = "Absolute Void")
    void InduceAbsoluteConceptualUltimateOblivion();

    UFUNCTION(BlueprintCallable, Category = "Absolute Void")
    void NegateAbsoluteUltimateExistence();
