...
#include "P13_EXST_OMEGA_OMEGA_INFINITE_ETERNAL.generated.h"
...
class SIMPLEAPP_API UP13_EXST_OMEGA_OMEGA_INFINITE_ETERNAL : public UActorComponent
{
    GENERATED_BODY()

public:
    UP13_EXST_OMEGA_OMEGA_INFINITE_ETERNAL();
