...
#include "P02_CORE_CHAR_MODELS.generated.h"
...
class SIMPLEAPP_API UP02_CORE_CHAR_MODELS : public UActorComponent
{
    GENERATED_BODY()

public:
    UP02_CORE_CHAR_MODELS();
