...
#include "P09_EXST_ABSOLUTE.generated.h"
...
class SIMPLEAPP_API UP09_EXST_ABSOLUTE : public UActorComponent
{
    GENERATED_BODY()
...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Absolute Existence")
    float AbsolutePerpetuation;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Absolute Existence")
    float AbsoluteInfiniteContinuum;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Absolute Existence")
    float AbsoluteTimelessPerpetuation;
    ...
    UFUNCTION(BlueprintCallable, Category = "Absolute Existence")
    void AchieveAbsolutePerpetuation();

    UFUNCTION(BlueprintCallable, Category = "Absolute Existence")
    void MaintainAbsoluteInfiniteContinuum();

    UFUNCTION(BlueprintCallable, Category = "Absolute Existence")
    void PerpetuateAbsoluteTimelessly();
